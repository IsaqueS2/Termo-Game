...
namespace Termo_Game
{
    public class Termo
    {
        ...
        public void GerarPalavraAleatoria()
        {
            ...
            numeroAleatorio = RandomNumero.Next(0, 377);
            palavraSecreta = "CAIXA";
        }
        public bool VerificaPalavraCompleta() //1 etapa
        {
        ...
        public bool VerificaSeJogadorGanhou() //2 etapa
        {
        ...
        public bool VerificaSeJogadorPerdeu() //3 etapa
        {
            if (rodada == 4)
                return true;
        ...
        public bool VerificarVitoria() //4 etapa
        {
